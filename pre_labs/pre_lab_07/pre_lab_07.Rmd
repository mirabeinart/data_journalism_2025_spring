...
```{r echo=FALSE}
census_api_key("5d0157810e6ae4d9e52cbd48c289a27af6e8502a", install=TRUE)
```
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer** Howard County has the highest median household income.
...
Is the difference between Howard and everyone else significant? **Answer** Yes!!!! Very!!!
...
**Answer** 29 zipcodes have estimated median household incomes of less than \$50,000.
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer** What counties do the zip codes fall in? Are there any outliers (like a zipcode with a super high median income but in a county with an overall lower median income or vice versa)?

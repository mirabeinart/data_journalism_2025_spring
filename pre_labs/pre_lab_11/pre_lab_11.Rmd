...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer** The column with the number of votes for Harris/Walz is chr datatype, not dbl
...
**Task** Run the following code to extract the table we want, clean up the names and remove the total row. Look at the rename() function - what do you think the numbers 2 through 6 are referring to? **Answer** The numbers 2 through 6 are assigning the columns with their respective candidate names from the data that we scraped from the html table. 
...
**Task** Run the following code in the gray-colored codeblock below to find the <li> tags. What does the output suggest about how many <ul> tags there are in the HTML source? **Answer** Since there are so many (54 to be exact) <li> tags, we can assume that there are multiple <ul> tags as well. 
...
**Task** Run the following code in the gray-colored codeblock below to find the text inside <li> tags. Describe the output: **Answer** The output is a list of all of the <li> tags from the html page. 
...
### Task 11: Turn the contents of the <li> and <a> tags into a dataframe **Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer** The output gives us a url for each committee/subsection.

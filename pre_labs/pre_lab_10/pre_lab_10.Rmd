...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** It has information about precincts, as well as shape, length, and area. 
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** Information about precincts - school names, districts in congress and the house, along with shape information.
...
**Task** Run the following code. Describe the output in the space below. **Answer** Oooooooh a pretty map of the precincts in PG County!
...
**Task** Run the following code. Describe the output in the space below. **Answer** It filtered down to just MD counties!
...
**Task** Run the following code. Describe the output in the space below. **Answer** Beautiful counties!
...
**Task** Run the following code. Describe the output in the space below. **Answer** Precincts in PG County!

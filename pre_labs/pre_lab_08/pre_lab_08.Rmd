...
**Answer** The first step (mutate) is mutating the data to create a column that shows the difference in unaffiliated voters between 2022 and 2024. The second step is creating a new dataframe with the county name and difference in unaffiliated voters, showing them in descending order.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** a white block.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** a bar chart with the number of unaffiliated voters on the y-axis and the counties on the x-axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** This codeblock is ordering the counties in order of the number of unaffiliated voters.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It flipped the axes!
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It made the chart prettier!
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** Ooooooh it made it the economist theme (whatever that is) and it made the background blue!
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It gave the chart a title, changed the labels of the x and y axes for easier understanding, and gave a source for the data. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Number of contributions by date.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A beautiful line chart graph thing!
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It gave labels for the x-axis by week. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Ooooh now the dates are at an angle which makes them easier to read!
